...
export function Focus() {
    ...
    function handleFocus() {
        if (timers.focus < 1 || timers.rest < 1) {
            return;
        }
            ...
            <div className={styles.content}>
                ...
                <div className={styles["input-group"]}>
                    <div className={styles.input}>
                        ...
                        <input ref={focusInput} placeholder="Tempo de foco" type="number" />
                    </div>
                    <div className={styles.input}>
                        <Plus onClick={() => handleAddMinutes("rest")} />
                        <input ref={restInput} placeholder="Tempo de descanso" type="number" />
                    </div>
                </div>
                ...
                <div className={styles["button-group"]}>
                    {timerState === TimerState.PAUSED && (
                        <Button
                            onClick={handleFocus} disabled={timers.focus < 1 || timers.rest < 1}>Começar</Button>
                    )}
                    {timerState === TimerState.FOCUS && (
